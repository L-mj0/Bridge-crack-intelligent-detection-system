...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./icon/图片1.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(./icon/R-C.jpg);\n"
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/conan.jpg);")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "基于图像的桥梁表面智能检测软件"))
        self.label_4.setText(_translate("mainWindow", "基于图像的桥梁表面智能检测软件"))
        self.label_5.setText(_translate("mainWindow", "设置"))
        self.label_27.setText(_translate("mainWindow", "请您根据需求调整下列参数"))
